...
public class SyncSpacesWikiTask {
    ...
    public ReturnT<String> syncSpacesWiki() {
        ...
        try {
            ...
            LambdaQueryWrapper<ProjectInfo> lq = Wrappers.<ProjectInfo>lambdaQuery().select(ProjectInfo::getWikiToken, ProjectInfo::getWikiTitle, ProjectInfo::getId).isNotNull(ProjectInfo::getWikiToken);
